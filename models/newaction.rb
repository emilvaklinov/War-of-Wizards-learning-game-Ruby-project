class Newaction
  def self.all
    return ["If you get black spell, use code to return nil",
    ...
    "If there is a 'spell turns you into frog' make loop method to save from",
    "If there is a 'spell turns you into stone' make loop method to save from",
